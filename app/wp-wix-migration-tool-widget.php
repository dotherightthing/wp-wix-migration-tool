...
if ( !class_exists( 'Wp_Wix_Migration_Tool_Widget' ) ) {
   ...
   */
  class Wp_Wix_Migration_Tool_Widget extends WP_Widget {

    function __construct() {
      // Instantiate the parent object
      parent::__construct( false, 'Wix Migration Tool Widget' );
    }
     ...
     * This function's variables will be available to this template.
     */
      require(WP_WIX_MIGRATION_TOOL_PATH . 'views/admin/partials/wp-wix-migration-tool-widget.php');
    }
  }

}

if ( !function_exists( 'wp_wix_migration_tool_register_widgets' ) ) {
  ...
  function wp_wix_migration_tool_register_widgets() {
    register_widget( 'Wp_Wix_Migration_Tool_Widget' );
  }

  add_action( 'widgets_init', 'wp_wix_migration_tool_register_widgets' );
