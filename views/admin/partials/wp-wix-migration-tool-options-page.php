...
<div class="wrap">
  ...
  <h1><?php esc_attr_e( 'Wix Migration Tool', 'wp_admin_style' ); ?>: Placeholder blocks</h1>
    ...
    <div id="post-body" class="metabox-holder columns-2">
      ...
      <div id="post-body-content">
        ...
        <div class="meta-box-sortables ui-sortable">
           ...
           * then $wp_wix_migration_tool_datatype will be set to the default of ""
           * The user must make a selection so that we know which page to query,
           * so we show the selection box first.
           */
          if ( !isset( $wp_wix_migration_tool_datatype ) || ( $wp_wix_migration_tool_datatype === '') ) :
          ?>
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <form name="wp_wix_migration_tool_data_form" method="post" action="">

                <input type="hidden" name="wp_wix_migration_tool_form_submitted" value="Y" />

                <table class="form-table">
                  <tr>
                    <th>
                      <label for="wp_wix_migration_tool_datatype">Please select a block type:</label>
                    </th>
                    <td>
                      <select name="wp_wix_migration_tool_datatype" id="wp_wix_migration_tool_datatype">
                 ...
                 */
                  submit_button(
                    $text = 'Go!',
                    $type = 'primary',
                    $name = 'wp_wix_migration_tool_submit',
                    $wrap = true,
           ...
           * then $wp_wix_migration_tool_data will contain the body of the resulting JSON.
           */
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <p>This data set contains <?php echo count( $wp_wix_migration_tool_data ); ?> blocks.</p>

              <p>The first 6 are displayed below:</p>

              <div class="wp-wix-migration-tool-blocks">
                <ul>
                ...
                <?php
                  ...
                  foreach( $wp_wix_migration_tool_data as $key => $val ) {
                    echo "<li>" . wp_wix_migration_tool_html_image( $key ) . "</li>\r\n";
              ...
              <?php
                echo wp_wix_migration_tool_html_date();
              ?>
          ...
          <div class="postbox">
            ...
            <div class="inside">
              ...
              <div class="wp-wix-migration-tool-data"><pre><code><?php echo "{\r\n";

                  $count = 0;
                  $max_length = 6;

                  foreach( $wp_wix_migration_tool_data as $key => $val ) {
                    var_dump( $wp_wix_migration_tool_data[$key] );
            ...
            <div class="inside">
              ...
              <form name="wp_wix_migration_tool_data_form" method="post" action="">
                ...
                <p>
                  ...
                  <select name="wp_wix_migration_tool_datatype" id="wp_wix_migration_tool_datatype">
                    <option value="">None</option>
                    <option value="photos" <?php selected( $wp_wix_migration_tool_datatype, "photos" ); ?>>Coloured blocks</option>
                    <option value="users" <?php selected( $wp_wix_migration_tool_datatype, "users" ); ?>>Maps</option>
                  </select>
                </p>
                <p>
