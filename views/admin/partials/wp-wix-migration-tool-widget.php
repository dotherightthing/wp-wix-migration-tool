 ...
 *    WP Admin > Appearance > Widgets > Wix Migration Tool
 *
...
<p>
  ...
  <span id="<?php echo $this->get_field_name('number'); ?>-tip" class="wp-wix-migration-tool-tip">Minimum: 1 | Maximum: <?php echo count($wp_wix_migration_tool_data); ?></span>
</p>
